...
from fastapi import FastAPI
from app.api.router import api_router, text_router, chart_maker_router,validate_router,classify_router,explore_router
...
app.include_router(explore_router, prefix="/explore")